...
LIn_1 net7 net10 gnd 108 IND
Stage_1 net4 net34 net10 gnd gnd CASMOS (50 1 60)
LD_1 net12 net4 gnd 104 IND
CShunt_D_1 net4 gnd gnd gnd 100e-15 CAP
CSeries_D_1 net4 net3 gnd gnd 43e-15 CAP

LIn_2 net24 net3 gnd 56 IND
Stage_2 net16 net23 net3 gnd gnd CASMOS (50 2 60)
LD_2 net17 net16 gnd 62 IND
CShunt_D_2 net16 gnd gnd gnd 50e-15 CAP
